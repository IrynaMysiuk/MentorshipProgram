...
import com.epam.mentorshipProgram.constants.Constants;

import java.lang.reflect.Field;
import java.lang.reflect.Modifier;

import static com.epam.mentorshipProgram.constants.Constants.A_VALUE;
import static com.epam.mentorshipProgram.constants.Constants.B_VALUE;
...
public class UnknownType {
    ...
    public void getUnknownType() {
        Class<?> cls;
        try {
            cls = Class.forName("com.epam.mentorshipProgram.utils.annotation.UnknownType");
